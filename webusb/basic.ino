...
WEBUSB_URL_DEF(landingPage, 1, "component-tester.netlify.app");
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(12), callback, FALLING);
}

void loop() {}
void callback() { Serial.print(response); webusb.print(response); }
